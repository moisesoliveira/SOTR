...
static PyObject *periodic_run(PyObject *self, PyObject *args){
    pthread_t t_1;
    pthread_t t_2;
    sigset_t alarm_sig;
    int i;
...
static PyMethodDef periodic_methods[] = {
    {"run", (PyCFunction) periodic_run, METH_NOARGS, NULL },
    
    PyMODINIT_FUNC initcserver(){
    Py_InitModule3("periodic", periodic_methods, "whatever");
}
